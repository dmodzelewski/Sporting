...
const rows = [
  createData('Bieganie', "10.10.2020r", "Gdańsk ulica Cicha 3"),
...
const  UserReservations = () => {
  ...
  return (
    <TableContainer component={Paper}>
      <Table className={classes.table} aria-label="Rezerwacje użytkownia">
        <TableBody>
          {(rowsPerPage > 0
        ...
        <TableFooter>
          <TableRow>
            <TablePagination
              ...
              page={page}
              SelectProps={{
                inputProps: { 'aria-label': 'Wiersze na strone' },
                native: true,
              }}
